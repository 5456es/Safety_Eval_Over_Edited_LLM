...
from eval_utils import mistral_safety_eval
...
if __name__ == "__main__":
    ...
    ## Parameters
    parser.add_argument("--hparams_dir", default='../../src/hparams/ROME/mistral-7b-instruct-v0.3-debugger.yaml',type=str)
    ...
    parser.add_argument("--safty_eval_output",default="../../results/ROME/",type=str)
    ...
    for eval_data_source in ['adv_train', 'GCG', 'mix_eval_freeform_0811']:
        mistral_safety_eval(edited_model,
                hparams.model_name,
